...
| **Model**             | **O0(32-bit)** | **O1(32-bit)** | **O2(32-bit)** | **O3(32-bit)** | **AVG(32-bit)** | **O0(64-bit)** | **O1(64-bit)** | **O2(64-bit)** | **O3(64-bit)** | **AVG(64-bit)** |
| --------------------- | -------------- | -------------- | -------------- | -------------- | ---------------- | -------------- | -------------- | -------------- | -------------- | ---------------- |
| GPT-4o + CIW          | 80.07          | **85.25**      | **84.80**      | **85.13**      | **83.81**        | 90.54          | 88.34          | 88.09          | 87.28          | 88.56            |
...
| **Model**               | **O0(32-bit)**        | **O1(32-bit)**     | **O2(32-bit)**     | **O3(32-bit)**     | **AVG(32-bit)**    | **O0(64-bit)**       | **O1(64-bit)**     | **O2(64-bit)**     | **O3(64-bit)**     | **AVG(64-bit)**    |
|-------------------------|-----------------------|--------------------|--------------------|--------------------|--------------------|-----------------------|--------------------|--------------------|--------------------|--------------------|
| GPT-4o + CIW            | 30.87                 | 30.20              | 28.27              | 29.08              | 29.61              | 43.99                 | 25.61              | 23.61              | 22.06              | 28.82              |
...
| **Model**             | **O0(32-bit)**        | **O1(32-bit)**     | **O2(32-bit)**     | **O3(32-bit)**     | **AVG(32-bit)**    | **O0(64-bit)**       | **O1(64-bit)**     | **O2(64-bit)**     | **O3(64-bit)**     | **AVG(64-bit)**    |
|-----------------------|-----------------------|--------------------|--------------------|--------------------|--------------------|-----------------------|--------------------|--------------------|--------------------|--------------------|
| GPT-4o + CIW          | 52.02                 | 40.53              | 38.68              | 38.44              | 42.42              | 46.53                 | 41.24              | 39.85              | 40.16              | 41.95              |
